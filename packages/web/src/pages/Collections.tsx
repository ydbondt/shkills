  ...
  return (
    <div className="pt-16">
      ...
      {!loading && collections.length === 0 && (
        <Empty title="No collections yet." detail="Group related skills so people join once." />
      )}
          ...
          >
            <Link to={`/collections/${collection.slug}`} className="flex-1">
              <div className="flex items-start justify-between gap-3">
                ...
                {collection.isDefault && <Chip>everyone</Chip>}
              </div>
            ...
            <div className="mt-5">
              {collection.locked ? (
                <span className="t-meta">Installed for everyone automatically</span>
              ) : (
                <button
